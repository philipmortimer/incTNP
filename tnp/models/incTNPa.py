# Causally masked autoregressice incremental TNP. Same as TNP-A just using causal masking for effecient incremental updates.
...
class ARincTNPEncoder(nn.Module):
    def __init__(
        self,
